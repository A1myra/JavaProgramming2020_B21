...
public class TravelTask {
    ...
    public static void main(String[] args) {
        ...
        if(validPassport.equalsIgnoreCase("yes")){
            ...
            input.nextLine();// to accept the enter input
            ...
            if(numOfPeople >= 3){ //if you traveling with more than or equal to 3 people, cost will discount,
                cost -= 300;
            }else{
            ...
            System.out.println("Your ticket is booked to "+country+". we have charged extra for the "+bags
                    +"bags. but you are traveling with "+nameOfPeople+" so we are giving a discount. your total cost is "+cost);
